...
export class ProjectsSpace {
  constructor (public service:ServicesProject) {}
    ...
    projects = [
      {title: 'Teste 1', image: 'assets/imgs/devexemplos.jpg', description: 'TESTE TESTE TESTE', git: 'https://github.com/Ryanfs-ng', web: 'https://github.com/Ryanfs-ng', icon: 'assets/icons/reactjs-line-black.svg', languages:['HTML', 'React Native']},
